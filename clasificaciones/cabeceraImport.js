  ...
  <div class="row d-flex flex-wrap align-items-center">
    <div class="col-4">
      <a class="btn btn-dark" href="../pantalla_principal/pantalla_principal.html" style="vertical-align: middle;">
        <img src="../res/logo.png" alt="Logo de Todofútbol" height="50" style="vertical-align: middle;" />
    ...
    <div class="col-2">
      <a hidden id="dropdown" class="btn btn-dark" href="../equipo/equipos_favoritos.html" style="vertical-align: middle;">
        <img src="../res/icono-favoritos.png" alt="Icono de favoritos" height="50" style="vertical-align: middle;" />
    ...
    <div class="col-2 d-flex flex-wrap justify-content-end pe-5">
      ...
      <a class="btn btn-dark fs-5" id="login" aria-describedby="login" href="../login.html"><img class="me-2" src="../res/icono-login.png" alt="Icono de cuenta" height="40"/>Acceder</a>
